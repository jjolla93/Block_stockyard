...
class Worker():
    def __init__(self, game, name, s_size, a_size, trainer, model_path, global_episodes):
        ...
        self.summary_writer = tf.summary.FileWriter("../Workers/%d-%d-%d/train_" % (width, height, mode) + str(self.number))
            ...
            while not coord.should_stop():
                ...
                while d == False:
                    ...
                    if d == False:
                        ...
                        s1 = s
                    if self.env.block_moves != 0:
                        block_moves = self.env.block_moves
...
if not os.path.exists('../frames'):
    os.makedirs('../frames')
if not os.path.exists('../frames/%d-%d-%d' % (width, height, mode)):
    os.makedirs('../frames/%d-%d-%d' % (width, height, mode))
...
with tf.device("/cpu:0"):
    ...
    for i in range(num_workers):
        workers.append(Worker(Space(width, height, num_block, mode, target=0), i, s_size, a_size, trainer, model_path, global_episodes))
